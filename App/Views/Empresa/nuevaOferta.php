<?php $this->layout('layout', ['title' => 'Crear Oferta | ProyectaFP']) ?>
...
<?php $this->start('contenidoPagina') ?>
    <section class="auth-container">
        <div class="auth-card">
            <form action="index.php?page=guardarnuevaoferta" method="POST" enctype="multipart/form-data">
                <h1>Crear Oferta</h1>
                ...
                <div class="form-group">
                    ...
                    <textarea name="desc" id="desc" rows="3" cols="50" required></textarea>
                </div>
