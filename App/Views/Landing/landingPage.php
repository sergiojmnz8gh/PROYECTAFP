...
<?php $this->start('contenidoPagina') ?>
        <section>
            ...
            <article class="seccion-empresas-colaboradoras">
                        ...
                        <?php if (!empty($empresas)): ?>
                            <?php foreach ($empresas as $empresa): ?>
                                <div class="carrusel-item">
                                    <img src="<?= $empresa->logo ? $empresa->logo : '/assets/img/logo-defecto.png' ?>" 
                                        alt="Logo de <?= $empresa->nombre ?>" class="logo-empresa">
                                </div>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <p class="mensaje-sin-empresas">No hay empresas colaboradoras para mostrar en este momento.</p>
                        <?php endif; ?>
                    </div>
                </div>
            </article>
